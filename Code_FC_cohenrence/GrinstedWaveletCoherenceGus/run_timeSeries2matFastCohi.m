function Aij = run_timeSeries2matFastCohi(timeSeriesInput,inputTR,passBand,windowSizeInput,windowOverlapInput,analysisTypeInput,outputDir,subjectNameInput,taskNameInput,timeLag)
...
dataRange = [timeWinStart; timeWinEnd]'; 
...
for kk = 1:length(timeWinStart)
    ...
    elseif(strcmp(analysisType,'wavelet') || strcmp(analysisType,'wtc'))
        Aij{kk} = wtcMatrix(timeSeriesData(:,timeWinStart(kk):timeWinEnd(kk)),TR, bandPass,'mcc',0);      
    end
end